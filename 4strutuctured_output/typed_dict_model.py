...
class review(TypedDict):
    review:Annotated[str , "give a brief summary of the review  "] # Annotated used for more descriptive input 
    sentiment:Annotated[str , "give the emotions which u can find out from the review"] 
    keyPoints : Annotated[list[str] , " provide the key points present in the review"]
    pros : Annotated[Optional[list[str]] , "the pros present in the review"] # optional specifies that there can be a value or it can be null also .
    cons : Annotated[Optional[list[str]] , "the cons present in the review"]
